...
function draw(vector){
    ...
    marker.bindPopup("Kliknąłeś na punkt o wspł. " + '(' + vector[0] + ',' + vector[1] + ')').openPopup();
    ...
    function onMapClickMarker(e){
        ...
        marker2.setLatLng(e.latlng)
            .addTo(mymap);
        marker2.bindPopup("Kliknąłeś na punkt o wspł. " + e.latlng.toString().replace('LatLng','')).openPopup();
    }
